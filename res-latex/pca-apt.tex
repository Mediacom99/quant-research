...
First I need to show the histogram of the residuals using simple LinearRegression(OSL), then I can motivate the using a more robust regressor, then table with Cross Validation results, then explanation of chosen regressor. (Elastic net regularization, epsilon insensitive (linear support vector regression), SGD).
